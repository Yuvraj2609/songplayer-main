import tkinter #way in Python to create Graphical User interfaces (GUIs) and is included in all standard Python Distributions
from tkinter.ttk import Progressbar #indicates whether the code is completing its job or is stuck in an infinite loop.
import customtkinter  # a tkinter extension which provides extra ui-elements like the CTkButton, which can be used like a normal tkinter.
import pygame # provides cross-platform access to your system's underlying multimedia hardware components, such as sound, video, mouse, keyboard, and joystick.
...
list_of_songs = ['music/Attention.mp3','music/HADTA-SANAM.mp3','music/Ride-It.mp3']
list_of_covers = ['img_1/2.jpg','img_1/3.jpg','img_1/city.jpg']
n = 0
